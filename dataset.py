...
class CUBDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Add this block to create 6-channel B-cos input
        inverted_img = 1.0 - img
        img_6ch = torch.cat([img, inverted_img], dim=0)  # Shape: [6, H, W]
        ...
        if self.use_attr:
            ...
            if self.no_img:
                ...
                return img_6ch, class_label, attr_label
        else:
            return img_6ch, class_label
